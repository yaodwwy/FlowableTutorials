...
import org.flowable.delegate.EventDelegate;
...
import cn.adbyte.flowable.standalone.pojo.MyBean;
import cn.adbyte.flowable.standalone.service.AuthService;
...
public class _7BPMN流程任务Test {
    ...
    public void 用户任务权限() {
        ...
        factory.deployAndStart("processes/_7BPMN用户任务权限.bpmn20.xml");
    ...
    public void 服务任务委托表达式() {
        ...
        factory.deployAndStart(vars, "processes/_7BPMN服务任务委托表达式.bpmn20.xml");
    }
    ...
    public void 服务任务JUEL表达式赋值取值测试() {
        ...
        ProcessInstance processInstance = factory.deployAndStart(vars, "processes/_7BPMN服务任务JUEL表达式.bpmn20.xml");
    ...
    public void BPMNShell任务() {
        ProcessInstance processInstance = factory.deployAndStart("processes/_7BPMN服务任务Shell任务.bpmn20.xml");
        System.out.println("返回结果：" + runService.getVariable(processInstance.getId(), "javaHome"));
    }

    @Test
    public void BPMN任务监听器() {
        ProcessInstance processInstance = factory.deployAndStart("processes/_7BPMN任务监听器.bpmn20.xml");
