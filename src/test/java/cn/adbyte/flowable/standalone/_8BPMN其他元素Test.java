...
public class _8BPMN其他元素Test {
    ...
    @Test
    public void 嵌入式子流程() {
        ProcessInstance processInstance = factory.deployAndStart("processes/_8BPMN嵌入式子流程.bpmn20.xml");
    ...
    @Test
    public void 调用子流程() {
        ProcessInstance processInstance = factory.deployAndStart(
        ...
        factory.complete(processInstance);
    ...
    @Test
    public void 事务子流程() {
        ProcessInstance processInstance = factory.deployAndStart("processes/_8BPMN事务子流程.bpmn20.xml");
    ...
    @Test
    public void 特殊子流程() {
        ProcessInstance processInstance = factory.deployAndStart("processes/_8BPMN特殊子流程.bpmn20.xml");
        // 获取执行流
    ...
    @Test
    public void 条件顺序流() {
        ProcessInstance processInstance = factory.deployAndStart("processes/_8BPMN条件顺序流.bpmn20.xml");
        ...
        System.out.println("当前任务：" + task.getName());
        // 完成第一个任务
        factory.complete(processInstance, vars);
    }

    @Test
    public void 并行网关() throws InterruptedException {
        ProcessInstance processInstance = factory.deployAndStart("processes/_8BPMN并行网关.bpmn20.xml");
    ...
    public void 多实例流程活动() {
        ...
        factory.deployAndStart(vars, "processes/_8BPMN多实例流程活动.bpmn20.xml");
